...
20. - [x] Race *(Skip `ability_bonuses`, `proficiencies`, `languages`, `traits`, `subraces`)*
...
25. - [x] Monster *(Skip complex nested structures needing resolution like specific ability scores, skills, proficiencies, actions needing lookups, special abilities needing lookups)*
