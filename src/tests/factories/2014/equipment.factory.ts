...
export const equipmentFactory = Factory.define<Equipment>(({ sequence }) => {
  ...
  return {
    ...
    armor_class: undefined, // armorClassFactory.build(),
    capacity: undefined,
    category_range: undefined,
    contents: undefined, // contentFactory.buildList(1),
    damage: undefined, // damageFactory.build(),
    gear_category: undefined,
    properties: undefined, // apiReferenceFactory.buildList(faker.number.int({ min: 0, max: 3 })),
    quantity: undefined,
    range: undefined, // rangeFactory.build(),
    special: undefined,
    speed: undefined, // speedFactory.build(),
    stealth_disadvantage: undefined,
    str_minimum: undefined,
    throw_range: undefined, // throwRangeFactory.build(),
    tool_category: undefined,
    two_handed_damage: undefined, // twoHandedDamageFactory.build(),
