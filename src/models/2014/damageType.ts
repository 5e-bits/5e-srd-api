...
@ObjectType({ description: 'Different types of damage (e.g., Acid, Bludgeoning, Fire).' })
@srdModelOptions('2014-damage-types')
export class DamageType {
  @Field(() => [String], { description: 'Description of the damage type.' })
  ...
  @Field(() => String, { description: 'The name of the damage type.' })
  @prop({ required: true, index: true, type: () => String })
  public name!: string
